...
export default function TeacherTopbar({ sectionTitle }: TeacherTopbarProps) {
  ...
  const teacherEmail = "faculty@indira.edu.in";
      ...
      <div className="flex items-center gap-2 flex-shrink-0">
          ...
          {notifOpen && (
            <div className="absolute right-0 mt-2 w-80 rounded-xl border border-slate-200 bg-white shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1)] overflow-hidden">
              <div className="flex items-center justify-between border-b border-slate-100 px-4 py-3">
                ...
                <span className="rounded-full bg-[#800000]/10 px-2 py-0.5 text-xs font-semibold text-[#800000]">2 new</span>
              </div>
              <div className="max-h-72 overflow-y-auto divide-y divide-slate-50">
                <div className="flex items-start gap-3 px-4 py-3 hover:bg-slate-50 transition-colors cursor-pointer">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-xs font-medium text-slate-700 leading-relaxed">DBMS Batch A attendance completed</p>
                ...
                <div className="flex items-start gap-3 px-4 py-3 hover:bg-slate-50 transition-colors cursor-pointer">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-xs font-medium text-slate-700 leading-relaxed">Please submit internal marks</p>
                    <p className="mt-0.5 text-[10px] text-slate-400">4 hours ago</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="relative" ref={profileRef}>
          ...
          >
            ...
            <span className="hidden sm:block text-xs font-semibold text-slate-700 truncate max-w-[100px]">{teacherName}</span>
          ...
          {profileOpen && (
            <div className="absolute right-0 mt-2 w-56 rounded-xl border border-slate-200 bg-white shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1)] overflow-hidden">
              <div className="border-b border-slate-100 px-4 py-3">
                <p className="text-sm font-semibold text-slate-900 truncate">{teacherName}</p>
